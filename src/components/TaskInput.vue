...
<template>
  <div class="task-input">
    <div class="input-row">
      ...
      >
        {{ aiParsing ? '' : '' }}
        <svg v-if="!aiParsing" width="14" height="14" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="quick-actions">
      ...
      >
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none"
          stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M12 17v-7"/><path d="M8 10l4-4 4 4"/><path d="M5 21h14"/>
        </svg>
        置顶
      </button>
      <button
    ...
    <div v-if="dueDate || important || pinned || isDaily || tags.length > 0" class="summary">
      ...
      <span v-if="pinned" class="summary-item">
        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 17v-7"/><path d="M8 10l4-4 4 4"/><path d="M5 21h14"/></svg>
        置顶
      </span>
